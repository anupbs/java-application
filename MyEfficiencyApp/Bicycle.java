...
/**
 * Bicycle class that implements the abstract methods of the super class. It provides the functionality to create a bicycle and calculate the efficiency 
 * of the bicycle.
 *
 * @author Group-19
 * @version 11/04/18
...
public class Bicycle extends Vehicle
{
    ...
    private final int govIncentive = 100;
    private final int avgCostOfRunning = 250;    
    private double efficiency;

    /**
     * Constructor for object of class Bicycle
     ...
     * @return This method does not return any value
     */ 
    public Bicycle(String id,int noOfDays, int noOfDeliveries, double valOfDeliveries, double milesCovered)
    {
    ...
    /**
     * Mutator Method to calculate efficiency of a Bicycle 
    ...
    public void calculateEfficiency()
    {
        ...
        try
        {
            efficiency = getValueOfDeliveries() / (getAvgCostOfRunning() - getGovIncentive());
        }
        catch(Exception e)
        {
            //Message displayed in a dialogue box if error occurs in the calculation
            JOptionPane.showMessageDialog(null,"Error occured while calculating Efficiency of Bicycle !","Error Message",JOptionPane.ERROR_MESSAGE);
        }
